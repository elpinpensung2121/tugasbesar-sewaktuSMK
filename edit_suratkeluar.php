...
include ("koneksi.php");
$id = $_GET['id'];
$query  = mysql_query("select * from surat_keluar where id='$id'");
$data = mysql_fetch_array($query);
?>


<form action= "update_suratkeluar.php" method=post>
<br><br><br><br><br><br><br><br><br><br><br><br><center><table border=1 width=400>

<tr>
<td colspan=2 align=center><marquee>Surat Keluar</marquee></td>
</tr>
